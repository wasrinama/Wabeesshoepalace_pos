...
const BarcodeScanner: React.FC<BarcodeScannerProps> = ({ onScan, onClose, isOpen }) => {
  ...
  const handleSuccessfulScan = (code: string): void => {
    // Add to scan history
  ...
  const handleManualEntry = (e: FormEvent<HTMLFormElement>): void => {
    e.preventDefault();
  ...
  const generateTestBarcode = (): void => {
    const testBarcodes = [
      '1234567890123',
      '9876543210987',
      '5555555555555',
